...
// Represents a collection of gems (cost, player tokens, bank)
...
export interface DevelopmentCard {
  ...
  colorBonus: Exclude<GemColor, GemColor.Gold>; // Gold cannot be a color bonus
  imageUrl?: string; // UI placeholder
}
